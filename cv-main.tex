%%%%%%%%%%%%%%%
% Andrei Botez (andrei@straja.org)
% 18 Sept, 2025
...
\mynames{Andrei\bibnamedelima Botez}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Andrei Botez}
  \vspace{8pt}% add a bit more breathing room between name and links

  \makefield{\faEnvelope[regular]}{\href{mailto:andrei@straja.org}{\texttt{Email address}}}
  ...
  \makefield{{\scriptsize\simpleicon{github}}}{\!\href{https://github.com/idshdx}{\texttt{Github profile}}}
  \makefield{\faLinkedin}
  {\href{https://www.linkedin.com/in/andrewww-botez}{\texttt{LinkedIn profile}}}

  %% Next line
  \makefield{\faGlobe}{\href{https://shady.straja.org}{\texttt{Personal Page}}}
  \makefield{\faSuitcase}{\href{https://idshdx.github.io/portfolio-page/}{\texttt{Resume Webpage}}}
  \makefield{\faBook}{\href{https://my.manualof.me/s/07659ba778e00016af1dd53712179203}{\texttt{Manual of Me}}}
...
\title{Curriculum Vitae Andrei Botez}
