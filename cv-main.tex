...
%% You can specify multiple names like this, especially if you have changed your name or if you need to highlight multiple authors. 
\mynames{Doe/John,Smith/Jane}
...
\leftheader{%
  ...
  \vspace{8pt}% add a bit more breathing room between name and links

  \makefield{\faEnvelope[regular]}{\href{mailto:john.doe@example.com}{\texttt{Email address}}}
  ...
  \makefield{{\scriptsize\simpleicon{github}}}{\!\href{https://github.com/johndoe}{\texttt{Github profile}}}
  \makefield{\faLinkedin}
  {\href{https://www.linkedin.com/in/johndoe}{\texttt{LinkedIn profile}}}

  %% Next line
  \makefield{\faGlobe}{\href{https://johndoe.example.com}{\texttt{Personal Page}}}
  \makefield{\faSuitcase}{\href{https://johndoe.github.io/portfolio/}{\texttt{Resume Webpage}}}
  \makefield{\faBook}{\href{https://example.com/manual-of-me}{\texttt{Manual of Me}}}
...
\title{Curriculum Vitae John Doe}
