...
\leftheader{%
  ...
  \makefield{\faEnvelope[regular]}{\href{mailto:andrei@straja.org}{\texttt{andrei@straja.org}}}
  ...
  \makefield{{\scriptsize\simpleicon{github}}}{\!\href{https://x.com/idshdx}{\texttt{Github profile}}}
  \makefield{\faLinkedin}
  {\href{http://www.linkedin.com/in/andrewww-botez}{\texttt{LinkedIn profile}}}

  %% Next line
  \makefield{\faGlobe}{\url{https://shady.straja.org}}
